...
public class AdminScreenController implements Initializable {
    ...
    @FXML
    private void availableTable(MouseEvent event) {
        Stage s = new Stage();
        Parent root = null;
        try {            
            root = FXMLLoader.load(getClass().getResource("availableTable.fxml"));
    ...
    @FXML
    private void curtomers(MouseEvent event) {
        Stage s = new Stage();
        Parent root = null;
        try {            
    ...
    private void logout(MouseEvent event) {
        ...
        dialogLayout.setHeading(new Text("Wyloguj"));
        dialogLayout.setBody(new Text("Czy chcesz się wylogować?"));
    ...
    private void exit(MouseEvent event) {
        ...
        dialogLayout.setBody(new Text("Czy chcesz wyjść z aplikacji?"));
    ...
    @FXML
    private void homeS(MouseEvent event) {
    }
